...
public final class JarResources {
	...
	public static void mainOld(String[] args) throws IOException {
		if (args.length != 2) {
			...
			throw new IOException("usage: java JarResources <jar file name> <resource name>");
		}
	...
	public static boolean getFileOutOfJar(String jarLoc, String fileNameInJar,
			String newFileDirAndName) {
		try {
			JarResources jar = new JarResources(jarLoc);
			byte[] byteArray = jar.getResource(fileNameInJar);
			File someFile = new File(newFileDirAndName);
